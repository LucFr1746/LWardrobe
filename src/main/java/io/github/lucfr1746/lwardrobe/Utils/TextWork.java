package io.github.lucfr1746.lwardrobe.Utils;
...
public class TextWork {
    ...
    private static String setPlaceholder(Player p, String input) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null)
            input = PlaceholderAPI.setPlaceholders(p, input);
        return input;
    }
    private static String setPlaceholder(OfflinePlayer p, String input) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null)
            input = PlaceholderAPI.setPlaceholders(p, input);
        return input;
    }
